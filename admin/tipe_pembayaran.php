                            ...
                            <div class="content">
                                ...
                                <div class='panel panel-border panel-primary'>
                                   <div class='panel-heading'> 
                                       ...
                                       <p align='left'><a class='btn btn-primary' href='tambah_tipe_pembayaran.php'><i class='icon-plus'></i>Tambah Tipe Pembayaran</a></p>
                                       <hr>
                                       <table id='datatable' class='table table-hover'>
                                          ...
                                          <tbody><tr>
                                           <td>26</td>
                                           <td>BANK </td>
                                           <td><a class='btn btn-primary' href='?p=pembayaran&aksi=edit&id=26'><i class='icon-edit'></i>Edit</a>
                                               <a class='btn btn-danger' href='pembayaran/aksi_pembayaran.php?act=hapus&id=26' onClick="return confirm('Anda yakin ingin menghapus ini?');"><i class='icon-trash'></i>Hapus</td>
