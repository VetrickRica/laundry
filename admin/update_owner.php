	...
	<div class="content">
		<div class="container">
			...
			<body>
				<div class='row'>
					<div class='col-sm-12'>
						<h4 class='pull-left page-title'>Update Data Owner</h4>
						<ol class='breadcrumb pull-right'>
							<li><a href='#'>Beranda</a></li>
							<li class='active'>Update Data Owner</li>
						</ol>
					</div>
				</div>
				...
				<div class='col-sm-12'>
					<div class='panel panel-default'>
						<div class='panel-heading'><h3 class='panel-title'>Update Data Owner</h3></div>
							...
							<div class='form'>
								<form method='post' action="" class='cmxform form-horizontal tasi-form' id='commentForm'>
									...
									<div class='form-group'>
										...
										<div class='col-lg-10'>
											<input type='text' class='form-control' name='nama' value="<?php echo $user["nama"] ?>" placeholder='Masukan Nama Owner' required>
										</div>
									</div>
