                                ...
                                <div class='row'>
                                    <div class='col-sm-6 col-lg-3'>
                                        <div class='mini-stat clearfix bx-shadow bg-white'>
                                            ...
                                            <div class='mini-stat-info text-right text-dark'><span class='counter text-dark'>49</span>
                                                Total Customer
                                            </div>
                                        </div>
                                    </div>
                                    <div class='col-sm-6 col-lg-3'>
                                        <div class='mini-stat clearfix bx-shadow bg-white'>
                                            ...
                                            <div class='mini-stat-info text-right text-dark'><span class='counter text-dark'>36</span>
                                                Total Karyawan
                                            </div>
                                        </div>
                                    </div>
                                    <div class='col-sm-6 col-lg-3'>
                                        <div class='mini-stat clearfix bx-shadow bg-white'>
                                            ...
                                            <div class='mini-stat-info text-right text-dark'><span class='counter text-dark'>98</span>
                                                New Order
                                            </div>
                                        </div>
                                    </div>
                                    <div class='col-sm-6 col-lg-3'>
                                        <div class='mini-stat clearfix bx-shadow bg-white'>
                                            ...
                                            <div class='mini-stat-info text-right text-dark'> <span class='counter text-dark'>213</span>
                                                Total Order
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table id='datatable' class='table table-hover'>
                                            ...
                                            <tbody>
                                                <tr>
                                                 ...
                                                 <td><b>02/18/2020</b></td>
                                                 <td><b>Ridwan</b></td>
                                                 <td><b>Baju</b></td>
                                                 <td><b>Belum Lunas</b></td>
                                                 <td><b>Baru</b></td>
                                                 <td><b>Rp. 60.090,-</b></td>
                                                 <td><a class='btn btn-primary' href='?p=ordermasuk&aksi=detailorder&id=ORD-000213'><i class='icon-edit'></i>Detail</a></td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td><a class='btn btn-primary' href='?p=ordermasuk&aksi=detailorder&id=ORD-000212'><i class='icon-edit'></i>Detail</a></td>
