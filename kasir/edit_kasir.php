                                    ...
                                    <div class='panel panel-default'>
                                        ...
                                        <div class='panel-body'>
                                            <div class='form'>
                                                ...
                                                <form method='post' action='karyawan/aksi_karyawan.php?act=update' class='cmxform form-horizontal tasi-form' id='commentForm'>
                                                    ...
                                                    <div class='form-group'>
                                                     ...
                                                     <div class='col-lg-10'>
                                                        <input type='text' class='form-control' name='username'  value='karyawan' placeholder='Masukan Username' required disabled>
                                                    </div>
                                                </div>
                                            ...
                                            <div class='form-group'>
                                             ...
                                             <div class='col-lg-10'>
                                              <textarea class='form-control' id='ccomment' name='alamat' required='' aria-required='true' placeholder='Alamat Karyawan'>jl.awaw</textarea>
                                          </div>
                                      </div>
                                      ...
                                      <div class='form-group'>
                                         ...
                                         <div class='col-lg-10'>
                                            <input type='number' class='form-control' name='telp' value='081231231233' placeholder='Masukan No. Telepon' required>
                                        </div>
                                    </div>
