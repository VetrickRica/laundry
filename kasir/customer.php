												...
												<table id='datatable' class='table table-hover'>
													...
													<tbody>
														<tr>
															...
															<td>Bogor</td>
															<td>08558857062</td>
															<td><a class='btn btn-primary' href='?p=customer&aksi=edit&id=49'><i class='icon-edit'></i>Edit</a>
																<a href='#' class='btn btn-danger' onClick="return confirm('Anda yakin ingin menghapus ini?');"><i class='icon-trash'></i>Hapus</td>
																	...
																	<td>123</td>
																	<td>08</td>
																	<td><a class='btn btn-primary' href='?p=customer&aksi=edit&id=48'><i class='icon-edit'></i>Edit</a>
																		<a href='#' class='btn btn-danger' onClick="return confirm('Anda yakin ingin menghapus ini?');"><i class='icon-trash'></i>Hapus</td>
